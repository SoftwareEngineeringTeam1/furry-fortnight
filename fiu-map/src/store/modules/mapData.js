const state = {
    ...
    myDataList2: [
        {location: 'PG6', coordinates: [-80.374625, 25.760122], count: 1, color: '#CC0000'},
        {location: 'Architect Building', coordinates: [-80.375456, 25.758898], count: 1, color: '#CC0000'},
        {location: 'ECS', coordinates: [-80.373875, 25.759039], count: 1, color: '#CC0000'},
        {location: 'Chem & Phy Building', coordinates: [-80.372234, 25.758340], count: 8, color: '#CC0000'},
        {location: 'Ryder Business', coordinates: [-80.376131, 25.757444], count: 8, color: '#CC0000'},
        {location: 'S&D Green Library', coordinates: [-80.373867, 25.757200], count: 9, color: '#CC0000'},
        {location: 'School Pub Aff', coordinates: [-80.376095, 25.756512], count: 100, color: '#CC0000'}
    ],
    myDataList3: [
        {location: 'PG6', coordinates: [-80.374625, 25.760122], count: 4, color: '#CC0000'},
        {location: 'Architect Building', coordinates: [-80.375456, 25.758898], count: 4, color: '#CC0000'},
        {location: 'AHC1', coordinates: [-80.371388, 25.757660], count: 4, color: '#CC0000'},
        {location: 'AHC2', coordinates: [-80.371270, 25.758082], count: 4, color: '#CC0000'},
        {location: 'Owa Ehan', coordinates: [-80.372975, 25.758014], count: 4, color: '#CC0000'},
        {location: 'Ryder Business', coordinates: [-80.376131, 25.757444], count: 4, color: '#CC0000'},
        {location: 'S&D Green Library', coordinates: [-80.373867, 25.757200], count: 4, color: '#CC0000'},
        {location: 'School Pub Aff', coordinates: [-80.376095, 25.756512], count: 100, color: '#CC0000'}
    ],
